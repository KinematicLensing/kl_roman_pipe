...
class TestBasicRendering:
    ...
    def test_native_orientation_intensity(self, test_galaxy, image_pars_test):
        ...
        config = TNGRenderConfig(target_redshift=0.6, 
...
class TestOrientation:
    ...
    def test_face_on_rendering(self, test_galaxy, image_pars_test):
        ...
        gen = TNGDataVectorGenerator(test_galaxy)
        pars = {'theta_int': 0.0, 'cosi': 1.0, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            band='r',
    ...
    def test_edge_on_rendering(self, test_galaxy, image_pars_test):
        ...
        gen = TNGDataVectorGenerator(test_galaxy)
        pars = {'theta_int': 0.0, 'cosi': 0.1, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            band='r',
            use_native_orientation=False,
    ...
    def test_orientation_affects_maps(self, test_galaxy, image_pars_test):
        ...
        # Face-on
        pars_face = {'theta_int': 0.0, 'cosi': 1.0, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_face = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test, band='r',
            use_native_orientation=False, pars=pars_face,
        )
        intensity_face, _ = gen.generate_intensity_map(config_face)
        velocity_face, _ = gen.generate_velocity_map(config_face)
        
        # Edge-on
        pars_edge = {'theta_int': 0.0, 'cosi': 0.1, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_edge = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test, band='r',
            use_native_orientation=False, pars=pars_edge,
        )
    ...
    def test_rotation_affects_maps(self, test_galaxy, image_pars_test):
        ...
        # PA = 0
        pars_0 = {'theta_int': 0.0, 'cosi': 0.7, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_0 = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test, band='r',
            use_native_orientation=False, pars=pars_0,
        )
        velocity_0, _ = gen.generate_velocity_map(config_0)
        
        # PA = 90 degrees
        pars_90 = {'theta_int': np.pi/2, 'cosi': 0.7, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_90 = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test, band='r',
            use_native_orientation=False, pars=pars_90,
        )
...
class TestGridding:
    ...
    def test_cic_ngp_flux_conservation(self, test_galaxy, image_pars_test):
        ...
        config_cic = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band='r', use_cic_gridding=True)
        intensity_cic, _ = gen.generate_intensity_map(config_cic)
        
        config_ngp = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band='r', use_cic_gridding=False)
    ...
    def test_cic_smoother_than_ngp(self, test_galaxy, image_pars_test):
        ...
        assert nonzero_cic >= nonzero_ngp, "CIC should spread to at least as many pixels as NGP"
...
class TestNoise:
    ...
    def test_noise_increases_variance(self, test_galaxy, image_pars_test):
        ...
        gen = TNGDataVectorGenerator(test_galaxy)
        config = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band='r')
    ...
    def test_different_seeds_produce_different_noise(self, test_galaxy, image_pars_test):
...
class TestPhotometricBands:
    ...
    def test_all_bands_work(self, test_galaxy, image_pars_test, band):
        ...
        gen = TNGDataVectorGenerator(test_galaxy)
        config = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band=band)
    ...
    def test_dusted_vs_raw(self, test_galaxy, image_pars_test):
        ...
        config_dusted = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band='r', use_dusted=True)
        intensity_dusted, _ = gen.generate_intensity_map(config_dusted)
        
        config_raw = TNGRenderConfig(target_redshift=0.6, image_pars=image_pars_test, band='r', use_dusted=False)
    ...
    def test_invalid_shear_raises_error(self, test_galaxy, image_pars_test):
        ...
        with pytest.raises(ValueError, match="Shear too large"):
            TNGRenderConfig(
                ...
                image_pars=image_pars_test,
                use_native_orientation=False,
                pars={'cosi': 0.7, 'theta_int': 0.0, 'x0': 0.0, 'y0': 0.0, 'g1': 0.8, 'g2': 0.8},
            )
...
class TestSFRMap:
    ...
    def test_sfr_map_custom_orientation(self, test_galaxy, image_pars_test):
        ...
        gen = TNGDataVectorGenerator(test_galaxy)
        pars = {'theta_int': np.pi/4, 'cosi': 0.7, 'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config = TNGRenderConfig(
            target_redshift=0.6,
            image_pars=image_pars_test,
            use_native_orientation=False,
...
class TestTransformRoundTrip:
    ...
    def test_custom_orientation_changes_maps(self, test_galaxy, image_pars_test):
        ...
        print(f"✓ Native velocity range: [{vel_native.min():.1f}, {vel_native.max():.1f}] km/s")
        print(f"✓ Custom velocity range: [{vel_custom.min():.1f}, {vel_custom.max():.1f}] km/s")
    ...
    def test_orientation_sweep_consistency(self, test_galaxy, image_pars_test):
        ...
        assert all(np.isfinite(s) and s > 0 for s in intensity_sums), \
            "All intensity sums should be finite and positive"
        assert all(np.isfinite(r) and r > 0 for r in velocity_ranges), \
        ...
        for i in range(len(inclinations) - 1):
            ...
            assert 0.5 < int_ratio < 2.0, \
                f"Intensity change from inc={inclinations[i]}° to {inclinations[i+1]}° too abrupt"
            
            vel_ratio = velocity_ranges[i+1] / velocity_ranges[i]
            assert 0.5 < vel_ratio < 2.0, \
                f"Velocity change from inc={inclinations[i]}° to {inclinations[i+1]}° too abrupt"
        
        print(f"✓ Inclination sweep passed: intensity sums = {[f'{s:.2e}' for s in intensity_sums]}")
        print(f"✓ Inclination sweep passed: velocity ranges = {[f'{r:.1f}' for r in velocity_ranges]}")
...
class TestInclinationSymmetry:
    ...
    def test_tng_asymmetric_under_inclination_flip(self, test_galaxy, image_pars_test):
        ...
        config_1 = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            use_native_orientation=False,
            pars=pars_1,
            use_cic_gridding=True,
        ...
        config_2 = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            use_native_orientation=False,
            pars=pars_2,
            use_cic_gridding=True,
    ...
    def test_face_on_vs_face_on_from_below(self, test_galaxy, image_pars_test):
        ...
        config_above = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            use_native_orientation=False,
            pars=pars_above,
            use_cic_gridding=True,
        ...
        config_below = TNGRenderConfig(target_redshift=0.6, 
            image_pars=image_pars_test,
            use_native_orientation=False,
            pars=pars_below,
            use_cic_gridding=True,
...
class TestDiagnosticPlots:
    ...
    @staticmethod
    def compute_robust_intensity_bounds(intensity_map, log=True, lower_percentile=2.0, upper_percentile=98.0):
        """
    ...
    @staticmethod
    def add_scale_markers(ax, image_pars, scale_bar_arcsec=1.0, color='black'):
        """
        ...
        using_pixels = (abs(xlim[1] - image_pars.shape[1]) < 5 and 
                       abs(ylim[1] - image_pars.shape[0]) < 5)
        ...
        if using_pixels:
            ...
            ax.plot([x_start, x_start + scale_bar_pixels], [y_start, y_start], 
                    color=color, linewidth=3, solid_capstyle='butt')
            ax.text(x_start + scale_bar_pixels/2, y_start + 0.04*image_pars.shape[0], 
                    f'{scale_bar_arcsec}"', color=color, ha='center', va='bottom',
                    fontsize=8, weight='bold',
                    bbox=dict(boxstyle='round,pad=0.3', facecolor='white' if color=='black' else 'black', 
                             alpha=0.7, edgecolor=color))
            
            # Center marker in pixels
            cx, cy = image_pars.shape[1]//2, image_pars.shape[0]//2
            marker_size_pix = 5
            ax.plot([cx - marker_size_pix, cx + marker_size_pix], [cy, cy], 'k-', linewidth=0.8, alpha=0.6)
            ax.plot([cx, cx], [cy - marker_size_pix, cy + marker_size_pix], 'k-', linewidth=0.8, alpha=0.6)
            ...
            ax.plot([x_start, x_start + scale_bar_arcsec], [y_start, y_start], 
                    color=color, linewidth=3, solid_capstyle='butt')
            ax.text(x_start + scale_bar_arcsec/2, y_start + 0.04*fov_y, 
                    f'{scale_bar_arcsec}"', color=color, ha='center', va='bottom',
                    fontsize=8, weight='bold',
                    bbox=dict(boxstyle='round,pad=0.3', facecolor='white' if color=='black' else 'black', 
                             alpha=0.7, edgecolor=color))
            
            # Center marker in arcsec (fixed physical size)
            marker_size = 0.15  # Fixed size in arcsec
            ax.plot([-marker_size, marker_size], [0, 0], 'k-', linewidth=0.8, alpha=0.6)
            ax.plot([0, 0], [-marker_size, marker_size], 'k-', linewidth=0.8, alpha=0.6)
    ...
    def test_all_galaxies_high_res_native(self, tng_data, output_dir):
        ...
        - Column 1: Intensity maps (log scale, RdBu_r with white=0)
        ...
        image_pars = ImagePars(shape=(128, 128), pixel_scale=0.05, indexing='ij')  # High res
        target_z = 0.7
        native_z = 0.011
        
        fig = plt.figure(figsize=(12, 4 * n_galaxies))
        gs = GridSpec(n_galaxies, 2, figure=fig, hspace=0.15, wspace=0.25)
        ...
        for idx in range(n_galaxies):
            ...
            config = TNGRenderConfig(target_redshift=target_z, 
            ...
            im_int = ax_int.imshow(int_log, origin='lower', cmap='viridis', aspect='equal',
                                   vmin=vmin, vmax=vmax)
            ax_int.set_title(f'Intensity - Galaxy {idx} (ID={subhalo_id})', fontsize=10)
            ax_int.set_xlabel('Pixel X', fontsize=8)
            ax_int.set_ylabel('Pixel Y', fontsize=8)
            plt.colorbar(im_int, ax=ax_int, label='log$_{10}$(Flux)', fraction=0.046, pad=0.04)
            
            # Add metadata text
            flipped_str = " (flipped)" if flipped else ""
            ax_int.text(0.02, 0.98, f'inc={inc_deg:.1f}°{flipped_str}\nPA={pa_deg:.1f}°',
                       transform=ax_int.transAxes, va='top', ha='left',
                       bbox=dict(boxstyle='round', facecolor='white', alpha=0.8),
                       fontsize=8)
            
            # Add scale bar and center marker (white for intensity)
            self.add_scale_markers(ax_int, image_pars, scale_bar_arcsec=1.0, color='white')
            
            # Plot velocity with diverging colormap (white=0)
            ax_vel = fig.add_subplot(gs[idx, 1])
            vmax = np.nanmax(np.abs(velocity))
            im_vel = ax_vel.imshow(velocity, origin='lower', cmap='RdBu_r', aspect='equal',
                                   norm=MidpointNormalize(vmin=-vmax, vmax=vmax, midpoint=0))
            ax_vel.set_title(f'Velocity - Galaxy {idx} (ID={subhalo_id})', fontsize=10)
            ax_vel.set_xlabel('Pixel X', fontsize=8)
            ax_vel.set_ylabel('Pixel Y', fontsize=8)
            plt.colorbar(im_vel, ax=ax_vel, label=r'$v_\mathrm{LOS}$ [km/s]', fraction=0.046, pad=0.04)
            ...
            print(f"✓ Galaxy {idx} (SubhaloID={subhalo_id}): "
                  f"inc={inc_deg:.1f}°, PA={pa_deg:.1f}°, flipped={flipped}")
        
        fig.suptitle(f'TNG50 Galaxies - Native Orientation (z={native_z:.3f}→{target_z:.1f})', 
                     fontsize=14, y=0.995)
        gs.update(hspace=0.1, wspace=0.15)
        plt.savefig(output_dir / 'all_galaxies_native_highres.png', dpi=150, bbox_inches='tight')
        plt.close()
        
        print(f"✓ Saved diagnostic plot: {output_dir / 'all_galaxies_native_highres.png'}")
    
    def test_cic_vs_ngp_comparison(self, test_galaxy, output_dir):
        """
        Compare CIC vs NGP gridding side-by-side.
        
        Shows how Cloud-in-Cell (CIC) produces smoother maps than Nearest-Grid-Point (NGP).
        CIC = Cloud-in-Cell: particles contribute to 4 nearest pixels with bilinear weights
        NGP = Nearest-Grid-Point: particles contribute only to nearest pixel (faster but noisier)
        """
        import matplotlib.pyplot as plt
        ...
        # CIC
        config_cic = TNGRenderConfig(target_redshift=target_z, image_pars=image_pars, use_native_orientation=True, use_cic_gridding=True)
        int_cic, _ = gen.generate_intensity_map(config_cic, snr=None)
        vel_cic, _ = gen.generate_velocity_map(config_cic, snr=None)
        
        # NGP
        config_ngp = TNGRenderConfig(target_redshift=target_z, image_pars=image_pars, use_native_orientation=True, use_cic_gridding=False)
        ...
        # Intensity CIC - log scale with viridis
        int_log_cic = np.log10(int_cic + 1e-10)
        vmin, vmax = self.compute_robust_intensity_bounds(int_log_cic, log=True)
        im0 = axes[0, 0].imshow(int_log_cic, origin='lower', cmap='viridis', aspect='equal',
                                vmin=vmin, vmax=vmax)
        axes[0, 0].set_title('Intensity - Cloud-in-Cell (CIC)', fontsize=11)
        self.add_colorbar_matching_height(im0, axes[0, 0], label='log$_{10}$(Flux)')
        self.add_scale_markers(axes[0, 0], image_pars, scale_bar_arcsec=1.0, color='white')
        
        # Intensity NGP - log scale with viridis
        int_log_ngp = np.log10(int_ngp + 1e-10)
        im1 = axes[0, 1].imshow(int_log_ngp, origin='lower', cmap='viridis', aspect='equal',
                                vmin=vmin, vmax=vmax)
        axes[0, 1].set_title('Intensity - Nearest-Grid-Point (NGP)', fontsize=11)
        self.add_colorbar_matching_height(im1, axes[0, 1], label='log$_{10}$(Flux)')
        self.add_scale_markers(axes[0, 1], image_pars, scale_bar_arcsec=1.0, color='white')
        
        # Velocity CIC
        vmax = max(np.nanmax(np.abs(vel_cic)), np.nanmax(np.abs(vel_ngp)))
        im2 = axes[1, 0].imshow(vel_cic, origin='lower', cmap='RdBu_r', aspect='equal',
                                norm=MidpointNormalize(vmin=-vmax, vmax=vmax, midpoint=0))
        axes[1, 0].set_title('Velocity - Cloud-in-Cell (CIC)', fontsize=11)
        self.add_colorbar_matching_height(im2, axes[1, 0], label='v_LOS [km/s]')
        self.add_scale_markers(axes[1, 0], image_pars, scale_bar_arcsec=1.0)
        
        # Velocity NGP
        im3 = axes[1, 1].imshow(vel_ngp, origin='lower', cmap='RdBu_r', aspect='equal',
                                norm=MidpointNormalize(vmin=-vmax, vmax=vmax, midpoint=0))
        axes[1, 1].set_title('Velocity - Nearest-Grid-Point (NGP)', fontsize=11)
        self.add_colorbar_matching_height(im3, axes[1, 1], label='v_LOS [km/s]')
        self.add_scale_markers(axes[1, 1], image_pars, scale_bar_arcsec=1.0)
        
        fig.suptitle(f'Gridding Algorithm Comparison: CIC vs NGP (z=0.011→{target_z})', fontsize=13)
        plt.tight_layout()
        plt.savefig(output_dir / 'cic_vs_ngp_comparison.png', dpi=150, bbox_inches='tight')
        plt.close()
        
        print(f"✓ Saved CIC vs NGP comparison: {output_dir / 'cic_vs_ngp_comparison.png'}")
    ...
    def test_symmetry_breaking_inclinations(self, test_galaxy, output_dir):
        ...
        # First inclination
        pars_1 = {'cosi': np.cos(np.radians(inc_1)), 'theta_int': 0.0, 
                  'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_1 = TNGRenderConfig(target_redshift=target_z, image_pars=image_pars, use_native_orientation=False, 
                                    pars=pars_1, use_cic_gridding=True)
        int_1, _ = gen.generate_intensity_map(config_1, snr=None)
        vel_1, _ = gen.generate_velocity_map(config_1, snr=None)
        
        # Second inclination
        pars_2 = {'cosi': np.cos(np.radians(inc_2)), 'theta_int': 0.0,
                  'x0': 0.0, 'y0': 0.0, 'g1': 0.0, 'g2': 0.0}
        config_2 = TNGRenderConfig(target_redshift=target_z, image_pars=image_pars, use_native_orientation=False,
                                    pars=pars_2, use_cic_gridding=True)
        ...
        int_log_valid = np.concatenate([
            int_log_1[int_log_1 > threshold], 
            int_log_2[int_log_2 > threshold]
        ])
        ...
        # Row 1: inc=45° 
        im00 = axes[0, 0].imshow(int_log_1, origin='lower', cmap='viridis', aspect='equal',
                                 vmin=vmin, vmax=vmax)
        ...
        im01 = axes[0, 1].imshow(vel_1, origin='lower', cmap='RdBu_r', aspect='equal',
        ...
        # Row 2: inc=135°
        im10 = axes[1, 0].imshow(int_log_2, origin='lower', cmap='viridis', aspect='equal',
                                 vmin=vmin, vmax=vmax)
        axes[1, 0].set_title(f'Intensity - inc={inc_2}° (from below)', fontsize=11)
        plt.colorbar(im10, ax=axes[1, 0], label='log$_{10}$(Flux)')
        self.add_scale_markers(axes[1, 0], image_pars, scale_bar_arcsec=1.0, color='white')
        
        vmax_2 = np.nanmax(np.abs(vel_2))
        im11 = axes[1, 1].imshow(vel_2, origin='lower', cmap='RdBu_r', aspect='equal',
        ...
        im20 = axes[2, 0].imshow(int_diff_scaled, origin='lower', cmap='RdBu_r',
        ...
        im21 = axes[2, 1].imshow(vel_diff, origin='lower', cmap='RdBu_r',
                                 vmin=-vel_diff_max, vmax=vel_diff_max)
        axes[2, 1].set_title(f'Velocity Difference')
        plt.colorbar(im21, ax=axes[2, 1], label='Δv_LOS [km/s]')
        
        fig.suptitle(f'TNG Asymmetry: inc={inc_1}° vs inc={inc_2}°\n'
                     f'(Symmetric models would show zero difference)', fontsize=14)
        plt.tight_layout()
        plt.savefig(output_dir / 'symmetry_breaking_inclinations.png', dpi=150, bbox_inches='tight')
        plt.close()
        
        max_vel_diff = np.nanmax(np.abs(vel_diff))
        print(f"✓ Max velocity difference: {max_vel_diff:.1f} km/s (confirms asymmetry)")
    ...
    def test_resolution_and_snr_grid(self, test_galaxy, output_dir):
        ...
        for i, pix_scale in enumerate(pixel_scales):
            ...
            for j, snr in enumerate(snr_levels):
                config = TNGRenderConfig(target_redshift=target_z, image_pars=image_pars, 
                                        use_native_orientation=True, use_cic_gridding=True)
        ...
        vmin_int_global, vmax_int_global = self.compute_robust_intensity_bounds(np.array(all_int_log_values), log=True)
        ...
        for i, pix_scale in enumerate(pixel_scales):
            for j, snr in enumerate(snr_levels):
                ...
                int_log = np.log10(np.clip(intensity, 1e-10, None))
                im_int = ax_int.imshow(int_log, origin='lower', cmap='viridis', aspect='equal',
                                       vmin=vmin_int_global, vmax=vmax_int_global)
                ...
                ax_vel = axes[i + 3, j]
                im_vel = ax_vel.imshow(velocity, origin='lower', cmap='RdBu_r',
                                      norm=MidpointNormalize(vmin=-vmax_vel_global, vmax=vmax_vel_global, midpoint=0), aspect='equal')
        ...
        # Add row labels
        fig.text(0.02, 0.75, 'INTENSITY', rotation=90, va='center', fontsize=12, weight='bold')
        fig.text(0.02, 0.25, 'VELOCITY', rotation=90, va='center', fontsize=12, weight='bold')
        
        fig.suptitle(f'Resolution & SNR Variations (Fixed FOV={fov_arcsec}" at z={target_z})', 
                     fontsize=14, y=0.995)
        plt.tight_layout(rect=[0.03, 0, 1, 0.99])
        plt.savefig(output_dir / 'resolution_snr_grid.png', dpi=150, bbox_inches='tight')
        plt.close()
        
        print(f"✓ Saved resolution/SNR grid with intensity+velocity: {output_dir / 'resolution_snr_grid.png'}")
    ...
    def test_glamour_shot(self, output_dir):
        ...
        image_pars_highres = ImagePars(shape=(160, 160), pixel_scale=0.025, indexing='ij')
        ...
        im00 = ax00.imshow(int_log, origin='lower', cmap='viridis', aspect='equal',
                          vmin=vmin_int, vmax=vmax_int, extent=extent_highres)
        ...
        self.add_scale_markers(ax00, image_pars_highres, scale_bar_arcsec=0.5, color='white')
        ax00.text(0.95, 0.95, 'pix=0.025"', transform=ax00.transAxes,
        ...
        im01 = ax01.imshow(halpha_log, origin='lower', cmap='viridis', aspect='equal',
                          vmin=vmin_ha, vmax=vmax_ha, extent=extent_highres)
        ...
        self.add_scale_markers(ax01, image_pars_highres, scale_bar_arcsec=0.5, color='white')
        ax01.text(0.95, 0.95, 'pix=0.025"', transform=ax01.transAxes,
                 fontsize=9, va='top', ha='right',
                 bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
        ...
        im02 = ax02.imshow(vel_clean, origin='lower', cmap='RdBu_r', aspect='equal',
        ...
        ax02.text(0.95, 0.95, 'pix=0.025"', transform=ax02.transAxes,
                 fontsize=9, va='top', ha='right',
                 bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
        ...
        int_noisy_log = np.log10(np.clip(int_noisy, 1e-10, None))  # Clip negatives from noise
        vmin_int_noisy, vmax_int_noisy = self.compute_robust_intensity_bounds(int_noisy_log, log=True)
        im10 = ax10.imshow(int_noisy_log, origin='lower', cmap='viridis', aspect='equal',
                          vmin=vmin_int_noisy, vmax=vmax_int_noisy, extent=extent_datavec)
        ...
        self.add_scale_markers(ax10, image_pars_datavec, scale_bar_arcsec=1.0, color='white')
        ax10.text(0.95, 0.95, 'pix=0.1"', transform=ax10.transAxes,
                 fontsize=9, va='top', ha='right',
                 bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
        
        # Bottom middle: Hα DataVector - compute separate bounds for noisy data
        ax11 = fig.add_subplot(gs[1, 1])
        halpha_noisy_log = np.log10(np.clip(halpha_noisy, 1e-10, None))  # Clip negatives from noise
        vmin_ha_noisy, vmax_ha_noisy = self.compute_robust_intensity_bounds(halpha_noisy_log, log=True)
        im11 = ax11.imshow(halpha_noisy_log, origin='lower', cmap='viridis', aspect='equal',
                          vmin=vmin_ha_noisy, vmax=vmax_ha_noisy, extent=extent_datavec)
        ...
        self.add_scale_markers(ax11, image_pars_datavec, scale_bar_arcsec=1.0, color='white')
        ax11.text(0.95, 0.95, 'pix=0.1"', transform=ax11.transAxes,
                 fontsize=9, va='top', ha='right',
                 bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
        
        # Bottom right: Velocity DataVector
        ax12 = fig.add_subplot(gs[1, 2])
        im12 = ax12.imshow(vel_noisy, origin='lower', cmap='RdBu_r', aspect='equal',
                          norm=MidpointNormalize(vmin=-vmax_vel, vmax=vmax_vel, midpoint=0),
        ...
        ax12.text(0.95, 0.95, 'pix=0.1"', transform=ax12.transAxes,
                 fontsize=9, va='top', ha='right',
                 bbox=dict(boxstyle='round', facecolor='white', alpha=0.8))
        
        fig.suptitle(f'TNG50 Galaxy (SubhaloID=8, z={target_z})', fontsize=14, y=0.98)
        plt.savefig(output_dir / 'glamour_shot_subhalo8.png', dpi=150, bbox_inches='tight')
        plt.close()
    ...
    def test_orientation_sweep_inclination(self, output_dir):
        ...
        image_pars = ImagePars(shape=(80, 80), pixel_scale=0.05, indexing='ij')  # 4 arcsec FOV
        target_z = 0.5  # Slightly closer for larger apparent size
        snr = None
        
        # Inclination sweep: native + cosi from 1 to 0 (face-on to edge-on)
        cosi_vals = np.array([1.0, 0.8, 0.6, 0.4, 0.2, 0.0])  # Fewer steps for cleaner plot
        n_inc = len(cosi_vals)
        ...
        for preserve_offset in [True, False]:
            ...
            mode_title = "Gas offset preserved" if preserve_offset else "Gas-stellar aligned"
            ...
            # Native orientation
            config_native = TNGRenderConfig(
                image_pars=image_pars, band='r', use_native_orientation=True,
                use_cic_gridding=True, target_redshift=target_z
            )
            ...
            for cosi, inc_deg in zip(cosi_vals, inc_deg_vals):
                ...
                config = TNGRenderConfig(
                    image_pars=image_pars, band='r', use_native_orientation=False,
                    use_cic_gridding=True, target_redshift=target_z, pars=pars,
            ...
            int_log_all = np.concatenate([np.log10(im + 1e-10).flatten() for im in all_intensities])
            vmin_int, vmax_int = self.compute_robust_intensity_bounds(int_log_all, log=True)
            ...
            # Intensity row (top)
            grid_int = ImageGrid(fig, 211, nrows_ncols=(1, n_cols), axes_pad=0.05,
            ...
            for idx, (intensity, title) in enumerate(zip(all_intensities, titles_int)):
                ...
                im = grid_int[idx].imshow(int_log, origin='lower', cmap='viridis', 
                                          aspect='equal', vmin=vmin_int, vmax=vmax_int, extent=extent)
                grid_int[idx].set_title(title, fontsize=9)
                grid_int[idx].set_xticks([])
                grid_int[idx].set_yticks([])
                if idx == 0:  # Scale bar on native column
                    self.add_scale_markers(grid_int[idx], image_pars, scale_bar_arcsec=1.0, color='white')
            ...
            # Velocity row (bottom)
            grid_vel = ImageGrid(fig, 212, nrows_ncols=(1, n_cols), axes_pad=0.05,
                                share_all=True, cbar_location="right", cbar_mode="single",
                                cbar_size="3%", cbar_pad=0.1)
            
            for idx, velocity in enumerate(all_velocities):
                im = grid_vel[idx].imshow(velocity, origin='lower', cmap='RdBu_r', aspect='equal',
                                          norm=MidpointNormalize(vmin=-vmax_vel, vmax=vmax_vel, midpoint=0),
                                          extent=extent)
                grid_vel[idx].set_xticks([])
                grid_vel[idx].set_yticks([])
                if idx == 0:
                    self.add_scale_markers(grid_vel[idx], image_pars, scale_bar_arcsec=1.0)
            ...
            fig.suptitle(f'TNG50 SubhaloID=8: Inclination Sweep ({mode_title})\n'
    ...
    def test_orientation_sweep_pa(self, output_dir):
        ...
        for preserve_offset in [True, False]:
            ...
            # Intensity row (top)
            grid_int = ImageGrid(fig, 211, nrows_ncols=(1, n_pa), axes_pad=0.05,
                                share_all=True, cbar_location="right", cbar_mode="single",
                                cbar_size="3%", cbar_pad=0.1)
            
            for idx, (pa_deg, intensity) in enumerate(zip(pa_deg_vals, all_intensities)):
                int_log = np.log10(intensity + 1e-10)
                im = grid_int[idx].imshow(int_log, origin='lower', cmap='viridis', 
                                          aspect='equal', vmin=vmin_int, vmax=vmax_int, extent=extent)
            ...
            # Velocity row (bottom)
            grid_vel = ImageGrid(fig, 212, nrows_ncols=(1, n_pa), axes_pad=0.05,
                                share_all=True, cbar_location="right", cbar_mode="single",
                                cbar_size="3%", cbar_pad=0.1)
            ...
            # Add info about gas-stellar offset
            offset_angle = gen._gas_stellar_L_angle_deg
            fig.suptitle(f'TNG50 SubhaloID=8: PA Sweep ({mode_title})\n'
